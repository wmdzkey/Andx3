...
public final class AboutVersionActivity_
    extends AboutVersionActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_about_version);
    }
    ...
    public static AboutVersionActivity_.IntentBuilder_ intent(Context context) {
        return new AboutVersionActivity_.IntentBuilder_(context);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, AboutVersionActivity_.class);
        }
        ...
        public AboutVersionActivity_.IntentBuilder_ flags(int flags) {
