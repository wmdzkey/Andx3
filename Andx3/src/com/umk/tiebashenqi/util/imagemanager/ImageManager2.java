...
import com.umk.andx3.base.BaseApplication;
...
public class ImageManager2 {
    ...
    public static ImageManager2 from(Context context) {
        ...
        if (imageManager == null) {
            imageManager = new ImageManager2(baseApp);
        }
    ...
    private byte[] loadByteArrayFromNetwork(String url) {
        ...
        try {
            ...
            HttpResponse response = baseApp.getaHttpClient().execute(method);
    ...
    public String urlToFilePath(String url) {
        ...
        // 图片存取路径
        filePath.append(baseApp.getCacheDir().toString()).append('/');
