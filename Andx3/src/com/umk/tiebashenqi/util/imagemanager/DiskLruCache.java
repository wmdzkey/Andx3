 ...
 */
package com.umk.tiebashenqi.util.imagemanager;
...
public class DiskLruCache {
	...
	/**
	 * Constructor that should not be called directly, instead use {@link DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra checks before creating a DiskLruCache
	 * instance.
	 * 
	 * @param cacheDir
	 * @param maxByteSize
	...
	/**
	 * Removes all disk cache entries from the given directory. This should not be called directly, call {@link DiskLruCache#clearCache(android.content.Context, String)} or
	...
	/**
	 * Writes a bitmap to a file. Call {@link DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set the target bitmap compression and format.
	 * 
	 * @param bitmap
	 * @param file
	 * @return
